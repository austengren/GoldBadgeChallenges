...
namespace Challenge_3_Tests
{
    ...
    public class OutingTests
    {
        ...
        public void Outing_AddToList_ShouldAddToList()
        {
            ...
            _outings.AddOutingToList(outing1);

            //-- Act
            int expected = 1;
            int actual = _outings.GetCount();
        ...
        public void Outing_GetList_ShouldGetList()
        {
            ...
            Outings outing1 = new Outings("Golf", 4, date1, 100.00);
            _outings.AddOutingToList(outing1);
            List<Outings> _testRepo = _outings.GetList();
        ...
        public void Outing_TotalEventCost_ShouldGetSum()
        {
            ...
            _outings.AddOutingToList(outing1);
            _outings.AddOutingToList(outing2);
            _outings.AddOutingToList(outing3);
            _outings.AddOutingToList(outing4);

            //-- Act
            double expected = 780;
            double actual = _outings.CostPerEvent();
        ...
        public void Outing_CostByEventType_ShouldGetTotalForEventType()
        {
            ...
            //-- Act
            double expected = 180;
            double actual = _outings.EventType("Golf");
